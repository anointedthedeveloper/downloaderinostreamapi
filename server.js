...
function getPlay(slug, path, token, subjectId, se, ep) {
  const playerUrl = `https://123movienow.cc/spa/videoPlayPage/movies/${slug}?id=${subjectId}&type=/movie/detail&detailSe=${se}&detailEp=${ep}&lang=en`;
  return new Promise((resolve, reject) => {
    https.request({
